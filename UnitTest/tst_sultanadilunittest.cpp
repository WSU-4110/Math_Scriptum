...
class SultanAdilUnitTest : public QObject
{
    Q_OBJECT
...
SultanAdilUnitTest::SultanAdilUnitTest()
{
...
void SultanAdilUnitTest::SaveImage()
{
...
void SultanAdilUnitTest::SaveImage_data()
{
...
void SultanAdilUnitTest::SelectSaveFile()
{
...
void SultanAdilUnitTest::SelectSaveFile_data()
{
    QTest::addColumn<QString>("input");
    QTest::addColumn<QString>("result");
...
void SultanAdilUnitTest::SaveProgress()
{
...
void SultanAdilUnitTest::SaveProgress_data()
{
    QTest::addColumn<QString>("input");
    QTest::addColumn<QString>("result");
...
void SultanAdilUnitTest::CreateSaveState()
{
...
void SultanAdilUnitTest::CreateSaveState_data()
{
    QTest::addColumn<QString>("input");
    QTest::addColumn<QString>("result");
...
void SultanAdilUnitTest::selectSaveState()
{
...
void SultanAdilUnitTest::selectSaveState_data()
{
    QTest::addColumn<QString>("input");
    QTest::addColumn<QString>("result");
...
QTEST_APPLESS_MAIN(SultanAdilUnitTest)

#include "tst_sultanadilunittest.moc"
